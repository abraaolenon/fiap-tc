...
class AvaliacaoControllerTest {
        ...
        void inserirAvaliacao() throws Exception {
                String host = "http://localhost:" + port + "/v1/avaliacoes";

                ResponseEntity<Avaliacao> respostaInserir = restTemplate.postForEntity(
                                host, null,
                                Avaliacao.class);

                ResponseEntity<Avaliacao[]> respostaConsulta = restTemplate
                                .getForEntity(host,
                                                Avaliacao[].class);
